<form action="admin.php" method="GET" id="ptt-searchform">
	...
	<p class="search-box">
		<label class="screen-reader-text" for="ptt-search-input"><?= _e('Search Tags'); ?>:</label>
		<input type="search" id="ptt-search-input" name="s" value="<?= $s; ?>" autofocus="autofocus" results="5" />
		<input type="submit" name="" id="search-submit" class="button" value="<?= _e('Search Tags'); ?>">
	</p>
</form>
...
<form action="admin.php" method="GET" class="ptt-pagination-form">
	...
	<div class="tablenav-pages">
		<span class="displaying-num disabled"><?= $terms_count; ?> <?= _e('Elements'); ?></span>
